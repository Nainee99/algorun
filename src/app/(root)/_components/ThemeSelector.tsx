...
const THEME_ICONS: Record<string, React.ReactNode> = {
  "vs-dark": <Moon className="size-3.5" />,
  "vs-light": <Sun className="size-3.5" />,
  "github-dark": <Github className="size-3.5" />,
  monokai: <Laptop className="size-3.5" />,
  "solarized-dark": <Cloud className="size-3.5" />,
};
